...
class FoodRevenueChartWidget extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => FoodRevenueChartWidgetState();
}

class FoodRevenueChartWidgetState extends State<FoodRevenueChartWidget> {
