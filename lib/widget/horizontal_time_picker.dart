...
import 'package:hues_foody_app/util/time_picker_util.dart';
...
class HorizontalTimePicker extends StatefulWidget {
  ...
  HorizontalTimePicker({
    ...
    this.spacingBetweenDates = 12.0,
    this.showDisabled = true,
    this.padding = const EdgeInsets.only(left: 25, right: 25, top: 10, bottom: 10)
